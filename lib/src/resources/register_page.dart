...
import 'package:logisticx/src/blocs/auth_bloc.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.white, //cho trung voi mau nen`
        iconTheme: IconThemeData(color: Color(0xff3277D8)),
        elevation: 0, //bo cai gach o duoi
      ),
      body: Container(
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all(Color(0xff3277D8)),
